...
// Compound indexes for AI aggregation pipeline optimization
TransactionSchema.index({ createdAt: 1, payment_method: 1 });
TransactionSchema.index({ "items.name": 1, createdAt: 1 });
TransactionSchema.index({ customer_name: 1, createdAt: -1 });
